...
# ==============================================================================
# 0. CONFIGURAÇÃO DO BANCO DE DADOS (ANDROID FRIENDLY)
# ==============================================================================
# No Android, não podemos criar arquivos em qualquer lugar.
# O banco será criado apenas na memória ou na pasta correta futuramente.
# Por enquanto, mantemos local para o build passar.
...
def main(page: ft.Page):
    ...
    def tela_extrato():
        ...
        def acao_pdf(e):
            ...
            try: os.startfile(gerar_pdf_financeiro(dados, saldo, mes))
                ...
                page.snack_bar = ft.SnackBar(ft.Text("PDF gerado (mas não foi possível abrir no celular)."))
        ...
        layout = ft.Column([
            ...
            ft.Container(content=txt_saldo, alignment=ft.Alignment(0, 0), padding=15, border_radius=15, bgcolor="#111", border=ft.border.all(1, "#222")),
            lista_transacoes,
    ...
    def mudar_tela(index):
        ...
        telas = [tela_extrato(), tela_cofrinho(), ft.Text("Simulador em breve...", text_align="center")]
    ...
    assinatura = ft.Container(
        content=ft.Text("Powered by AndyP", size=10, color="#333333", italic=True, weight=ft.FontWeight.W_300),
